 ...
 */
public class SearchListAdapter extends BaseQuickAdapter<SearchListBean.DatasBean, BaseViewHolder> {

    public SearchListAdapter(@Nullable List<SearchListBean.DatasBean> data) {
        super(R.layout.search_list_recycle_item,data);
    }

    @Override
    protected void convert(BaseViewHolder helper, SearchListBean.DatasBean item) {
        TextView tv_article_tag = helper.getView(R.id.tv_article_tag);
        List<SearchListBean.DatasBean.TagsBean> tags = item.getTags();
